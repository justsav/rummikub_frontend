    ...
    <>
      <Modal show={show} onHide={handleClose}>
        ...
        <ul>
          ...
          <li>Players starts with <strong>14 tiles</strong> each, and take turns, playing tiles from their own <strong>rack</strong> on to the <strong>game board</strong> when the tiles can form a set, or when the tiles can be added to an existing set.</li>
          ...
          <li><strong>Important</strong>: A player’s first play on the game board must be a set that totals 30 or more (sum of all tiles played).</li>
          <li>After a player has made the first move with a value over 30, any tiles can be played to the middle.</li>
          ...
          <li>Tiles can be added to other sets, and sets can be moved around to form new sets.</li>
          <li>During their turn, a player can re-arrange all played tiles on the game board, as long as at least one tile came from his/her pile, and every tile ends up in an acceptable set by the end of the turn.</li>
